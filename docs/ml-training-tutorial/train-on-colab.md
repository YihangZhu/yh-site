...
Mac or Windows users can install the Google Drive app and directly manage the
code in a folder, e.g., "imbalanced_classification" using an IDE, e.g., Pycharm.
The code can also be cloned directly from Github. The script sample is as
follows.
...
is a toy project that can be used.
